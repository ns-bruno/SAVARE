...
public class ConfiguracoesInternas {
    ...
    public static final int IDENTIFICACAO_NOTIFICACAO_SINCRONIZAR =  5290930;
    ...
    public static final int CODIGO_EMPRESA_USUARIO_PUBLICO_WEBSERVICE = 1;
    public static final int CODIGO_VENDEDOR_USUARIO_PUBLICO_WEBSERVICE = 1;
}
