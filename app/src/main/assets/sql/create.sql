...
-- Table: CFAPOSIT
CREATE TABLE IF NOT EXISTS CFAPOSIT (ID_CFAPOSIT INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE, ID_CFACLIFO INTEGER NOT NULL, ID_AEAORCAM INTEGER, DATA_VISITA DATE NOT NULL, VALOR_VENDA REAL, OBSERVACAO TEXT, STATUS CHAR (1) NOT NULL);
