...
-- Table: CFAMOEDA
CREATE TABLE IF NOT EXISTS CFAMOEDA (ID_CFAMOEDA  INTEGER NOT NULL, GUID CHAR(16) NOT NULL, US_CAD VARCHAR(20), DT_CAD DATETIME, DT_ALT DATETIME, CT_INTEG INTEGER, SIGLA VARCHAR(5) NOT NULL, DESCRICAO VARCHAR(40) NOT NULL, PLURAL VARCHAR(40) NOT NULL);
...
-- Table: CFACOTAC
CREATE TABLE IF NOT EXISTS CFACOTAC (ID_CFACOTAC INTEGER NOT NULL, ID_CFAMOEDA INTEGER NOT NULL, GUID CHAR(16) NOT NULL, US_CAD VARCHAR(20), DT_CAD DATETIME, DT_ALT DATETIME, CT_INTEG INTEGER, DATA DATE NOT NULL, VALOR NOT NULL DEFAULT (0) );
