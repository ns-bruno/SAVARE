...
-- Table: AEAPRREC
CREATE TABLE AEAPRREC (ID_AEAPRODU INTEGER NOT NULL, ID_CFAAREAS INTEGER, ID_CFACIDAD INTEGER, ID_CFACLIFO_VENDEDOR INTEGER, ID_CFACLIFO INTEGER, ID_SMAEMPRE INTEGER, POSICAO INTEGER);
