...
CREATE TABLE ULTIMA_ATUALIZACAO_DISPOSITIVO (ID_ULTIMA_ATUALIZACAO_DISPOSITIVO BIGINT, ID_DISPOSITIVO VARCHAR (100) NOT NULL, DT_CAD DATETIME NOT NULL, DT_ALT DATETIME, TABELA VARCHAR (100) UNIQUE NOT NULL, DATA_ULTIMA_ATUALIZACAO DATETIME NOT NULL);
...
UPDATE ULTIMA_ATUALIZACAO_DISPOSITIVO SET DT_ALT = (DATETIME('NOW', 'localtime')) WHERE TABELA = NEW.TABELA$^
