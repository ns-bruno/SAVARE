...
--^
--^
-- Retirado para melhorar a performace do app
...
^
^
-- Foi colocado o calculo do peso na aplicacao
--UPDATE AEAITORC SET ^
...
--^
--^
-- Tirado para melhorar o desempenho da aplicacao
--UPDATE AEAORCAM SET ^
...
--^
--^
-- Tirado para melhorar a performace do aplicativo
--UPDATE AEAORCAM SET ^
--		PESO_LIQUIDO = ROUND(IFNULL((SELECT SUM(AEAITORC.PESO_LIQUIDO) FROM AEAITORC WHERE (AEAITORC.ID_AEAORCAM = NEW.ID_AEAORCAM)), 0), 3),^
--		PESO_BRUTO = ROUND(IFNULL((SELECT SUM(AEAITORC.PESO_BRUTO) FROM AEAITORC WHERE (AEAITORC.ID_AEAORCAM = NEW.ID_AEAORCAM)), 0), 3)$^
--^
