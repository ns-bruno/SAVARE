...
-- Table: AEAFATOR
CREATE TABLE IF NOT EXISTS AEAFATOR (ID_AEAFATOR INTEGER NOT NULL PRIMARY KEY, DT_ALT DATETIME, CODIGO INTEGER NOT NULL, DESCRICAO VARCHAR(40) NOT NULL, JURO_MEDIO_ATAC REAL DEFAULT 0 NOT NULL, JURO_MEDIO_VARE REAL DEFAULT 0 NOT NULL, JURO_MEDIO_SERV REAL DEFAULT 0 NOT NULL, DESC_PG_ANT_ATAC REAL DEFAULT 0 NOT NULL, DESC_PG_ANT_VARE REAL DEFAULT 0 NOT NULL, DESC_PG_ANT_SERV REAL DEFAULT 0 NOT NULL, DESC_MAX_PLANO_ATAC_VISTA REAL DEFAULT 0 NOT NULL, DESC_MAX_PLANO_ATAC_PRAZO REAL DEFAULT 0 NOT NULL, DESC_MAX_PLANO_VARE_VISTA REAL DEFAULT 0 NOT NULL, DESC_MAX_PLANO_VARE_PRAZO REAL DEFAULT 0 NOT NULL, DESC_MAX_PLANO_SERV_VISTA REAL DEFAULT 0 NOT NULL, DESC_MAX_PLANO_SERV_PRAZO REAL DEFAULT 0 NOT NULL, TIPO_BONUS CHAR(1), DIAS_BONUS INTEGER DEFAULT 0 NOT NULL);
...
-- Table: AEAPRODU
CREATE TABLE IF NOT EXISTS AEAPRODU (ID_AEAPRODU INTEGER NOT NULL PRIMARY KEY, ID_AEAFAMIL INTEGER, ID_AEACLASE INTEGER, ID_AEAGRUPO INTEGER, ID_AEASGRUP INTEGER, ID_AEAMARCA INTEGER, ID_AEAUNVEN INTEGER NOT NULL, DT_CAD DATETIME, DT_ALT DATETIME, DESCRICAO VARCHAR (50) NOT NULL, DESCRICAO_AUXILIAR TEXT, CODIGO INTEGER, CODIGO_ESTRUTURAL VARCHAR (20), REFERENCIA VARCHAR (20), CODIGO_BARRAS VARCHAR (20), PESO_LIQUIDO REAL NOT NULL DEFAULT (0), PESO_BRUTO REAL NOT NULL DEFAULT (0), ATIVO CHAR (1) NOT NULL, TIPO CHAR (1));
...
-- Table: AEAPRREC
CREATE TABLE IF NOT EXISTS AEAPRREC (ID_AEAPRREC INTEGER PRIMARY KEY ON CONFLICT REPLACE AUTOINCREMENT, ID_AEAPRODU INTEGER NOT NULL, ID_CFAAREAS INTEGER, ID_CFACIDAD INTEGER, ID_CFACLIFO_VENDEDOR INTEGER, ID_CFACLIFO INTEGER, ID_SMAEMPRE INTEGER, POSICAO INTEGER, QUANTIDADE_VENDIDA REAL, VALOR_TOTAL_VENDA REAL, VALOR_TOTAL_CUSTO REAL);
...
INSERT INTO SERVIDORES (PORTA, IP_SERVIDOR, NOME, ID_SERVIDORES) VALUES (8080, 'savare.nowddns.com', 'Servidor 01', 1);
INSERT INTO SERVIDORES (PORTA, IP_SERVIDOR, NOME, ID_SERVIDORES) VALUES (8080, 'abramoski.no-ip.com', 'Servidor 02', 2);
INSERT INTO SERVIDORES (PORTA, IP_SERVIDOR, NOME, ID_SERVIDORES) VALUES (8080, 'abramoski.no-ip.info', 'Servidor 03', 3);
INSERT INTO SERVIDORES (PORTA, IP_SERVIDOR, NOME, ID_SERVIDORES) VALUES (8080, 'savare.now-dns.net', 'Servidor 04', 4);
INSERT INTO SERVIDORES (PORTA, IP_SERVIDOR, NOME, ID_SERVIDORES) VALUES (8080, 'savarewebservice.ddns.net', 'Servidor 05', 5);
...
CREATE INDEX IF NOT EXISTS INDEX_AEAEMBAL_ID_AEAUNVEN ON AEAEMBAL (ID_AEAUNVEN);
...
--^
--^
-- Tirado para melhorar a performace
--UPDATE AEAORCAM SET ^
--		PESO_LIQUIDO = ROUND(IFNULL((SELECT SUM(AEAITORC.PESO_LIQUIDO) FROM AEAITORC WHERE (AEAITORC.ID_AEAORCAM = NEW.ID_AEAORCAM)), 0), 3),^
--		PESO_BRUTO = ROUND(IFNULL((SELECT SUM(AEAITORC.PESO_BRUTO) FROM AEAITORC WHERE (AEAITORC.ID_AEAORCAM = NEW.ID_AEAORCAM)), 0), 3)$^
--^
